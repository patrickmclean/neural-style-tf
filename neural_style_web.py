...
# Leaving the command option here for debug
...
# Class called by the web server
# get this info into a config file
# and/or bring over an array rather than multiple single arguments

class launchNeuralStyle:
